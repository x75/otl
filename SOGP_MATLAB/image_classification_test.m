...
psogp = initPSOGP(gp_params, kernFunc, kernParams, 'c', 'n');
...
figure()
subplot(2,1,1);
plot(conf_levels,accuracies, 'r-'); title('Accuracies');
subplot(2,1,2);
plot(conf_levels,num_classified, 'b-'); title('Number Classified');
