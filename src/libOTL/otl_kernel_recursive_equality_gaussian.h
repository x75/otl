#ifndef OTL_KERNEL_RecursiveEqualityGaussian_8392890823901839021797947920183
#define OTL_KERNEL_RecursiveEqualityGaussian_8392890823901839021797947920183
...
class RecursiveEqualityGaussianKernel : public Kernel {
public:

    RecursiveEqualityGaussianKernel();
    RecursiveEqualityGaussianKernel(const RecursiveEqualityGaussianKernel &rhs);
    ~RecursiveEqualityGaussianKernel();
    /**
